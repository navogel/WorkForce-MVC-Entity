...
namespace EFWorkforce.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ComputerId"] = new SelectList(computers, "Id", "Model");
        ...
        public async Task<IActionResult> Create([Bind
            ("Id,FirstName,LastName,DepartmentId,Email,IsSupervisor,ComputerId, Email")] Employee employee)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ComputerId"] = new SelectList(_context.Computer, "Id", "Model", employee.ComputerId);
